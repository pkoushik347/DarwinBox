...
const fieldMatch = (inputField)=>{
    if(Array.isArray(inputField)){
        inputField.forEach(elem => elem.style.backgroundColor = 'green')
    }else{
        allInput.forEach(elem => elem.style.backgroundColor = 'grey')
    }
};
